...
local events =
{
    ...
    EventHandler("knockback", function(inst, data)
        if not inst.components.health:IsDead() and inst.components.follower.leader ~= data.knocker then
...
local states =
{
    ...
    State{
        ...
        onenter = function(inst, data)
			...
			print("KNOCK OUT !",inst.components.follower.leader,data.knocker)
...
return StateGraph("SGghostai", states, events, "appear")
