...
local function MakeWindow()
    ...
    inst.AnimState:SetBuild("pig_blu_h")
...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.components.spawner:Configure("pigman_blue", TUNING.TOTAL_DAY_TIME*4)
...
return Prefab("pighouse_blue", fn, assets, prefabs),
    MakePlacer("pighouse_blue_placer", "pig_house", "pig_blu_h", "idle")
